...
(function () {
  ...
  /* Toutes les couleurs viennent de shared/theme.css : ce fichier n'en écrit
     aucune en dur. C'est ce qui permet aux modales de suivre le mode
     monochrome — jusqu'en v1.18.0 elles gardaient l'ancienne palette dorée. */
  var CSS = [
    '.uim-backdrop{position:fixed;inset:0;background:var(--overlay);z-index:1000;',
    '  display:flex;align-items:center;justify-content:center;padding:20px;',
    '  opacity:0;transition:opacity .16s ease}',
    '.uim-backdrop.uim-in{opacity:1}',
    '.uim-backdrop.uim-level-2{z-index:1010;background:var(--overlay-2)}',
    '.uim-dialog{background:var(--panel);border-radius:var(--radius);width:100%;max-width:420px;',
    ...
    '.uim-msg{font-size:13.5px;line-height:1.55;color:var(--ink-soft);margin:0 0 16px;white-space:pre-line}',
    '.uim-field{width:100%;padding:10px 12px;border:1px solid var(--line-strong);border-radius:var(--radius-sm);',
    '  font-size:14px;font-family:inherit;color:var(--ink);background:var(--panel-2);outline:none;margin-bottom:16px}',
    '.uim-field:focus{border-color:var(--accent);box-shadow:0 0 0 3px var(--accent-soft)}',
    '.uim-label{display:block;font-size:12px;font-weight:600;color:var(--ink-soft);margin-bottom:6px}',
    '.uim-actions{display:flex;gap:9px;justify-content:flex-end}',
    '.uim-btn{padding:9px 16px;border-radius:var(--radius-sm);border:1px solid transparent;font-size:13.5px;',
    '  font-weight:600;font-family:inherit;cursor:pointer;transition:filter .12s,background .12s}',
    '.uim-btn:focus-visible{outline:2px solid var(--accent);outline-offset:2px}',
    '.uim-btn-ghost{background:var(--panel);border-color:var(--line-strong);color:var(--ink-soft)}',
    '.uim-btn-ghost:hover{background:var(--panel-2)}',
    '.uim-btn-primary{background:var(--accent);color:var(--on-accent)}',
    '.uim-btn-primary:hover{background:var(--accent-2)}',
    '.uim-btn-danger{background:var(--danger);color:var(--on-danger)}',
