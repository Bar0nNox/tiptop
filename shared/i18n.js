...
(function () {
  ...
  const DICT = {
    fr: {
      ...
      dash_sub_monthly: "S'abonner — {amount}/mois",
      // Relances de fin d'essai (v1.20.0) — confirmation depuis un lien d'e-mail
      dash_sub_confirm_title: "Confirmer votre abonnement",
      dash_sub_confirm_monthly: "Formule mensuelle, {amount} par mois, résiliable à tout moment. Vous allez être redirigé vers la page sécurisée de notre prestataire de paiement pour enregistrer votre carte. Lors de cet enregistrement, une autorisation de 0,10 € est demandée à votre banque pour vérifier la carte : elle est annulée immédiatement et n'est jamais débitée, mais peut apparaître quelques jours en attente sur votre relevé.",
      dash_sub_confirm_annual: "Formule annuelle, {amount} par an — deux mois et demi offerts par rapport au mensuel, résiliable à tout moment. Vous allez être redirigé vers la page sécurisée de notre prestataire de paiement pour enregistrer votre carte. Lors de cet enregistrement, une autorisation de 0,10 € est demandée à votre banque pour vérifier la carte : elle est annulée immédiatement et n'est jamais débitée, mais peut apparaître quelques jours en attente sur votre relevé.",
      ...
      dash_sub_annual: "S'abonner — {amount}/an",
      ...
      dash_no_card_warning: "Aucune carte enregistrée — votre abonnement prendra fin le {date}. Enregistrez une carte pour le poursuivre.",
      dash_card_saved_title: "Carte enregistrée",
      dash_card_saved_msg: "Votre carte est enregistrée. Aucun prélèvement immédiat : votre période en cours est déjà réglée, le prochain paiement aura lieu le {date}.",
      acc_add_card: "Enregistrer une carte",
      dash_price_unavailable: "Tarifs momentanément indisponibles. Rechargez la page ; si le problème persiste, écrivez-nous à contact@childish-agency.com.",
      ...
      acc_plan_monthly: "Mensuelle ({amount}/mois)", acc_plan_annual: "Annuelle ({amount}/an)",
    ...
    en: {
      ...
      dash_sub_monthly: "Subscribe — {amount}/month",
      // Trial reminders (v1.20.0) — confirmation from an email link
      dash_sub_confirm_title: "Confirm your subscription",
      dash_sub_confirm_monthly: "Monthly plan, {amount} per month, cancel any time. You will be taken to our payment provider's secure page to register your card. When registering, a €0.10 authorisation is requested from your bank to verify the card: it is cancelled immediately and never charged, but it may show as pending on your statement for a few days.",
      dash_sub_confirm_annual: "Yearly plan, {amount} per year — two and a half months free compared with monthly, cancel any time. You will be taken to our payment provider's secure page to register your card. When registering, a €0.10 authorisation is requested from your bank to verify the card: it is cancelled immediately and never charged, but it may show as pending on your statement for a few days.",
      ...
      dash_sub_annual: "Subscribe — {amount}/year",
      ...
      dash_no_card_warning: "No saved card — your subscription will end on {date}. Save a card to continue it.",
      dash_card_saved_title: "Card saved",
      dash_card_saved_msg: "Your card is saved. No immediate charge: your current period is already paid, the next payment will occur on {date}.",
      acc_add_card: "Save a card",
      dash_price_unavailable: "Pricing is temporarily unavailable. Please reload the page; if the problem persists, contact us at contact@childish-agency.com.",
      ...
      acc_plan_monthly: "Monthly ({amount}/month)", acc_plan_annual: "Yearly ({amount}/year)",
