...
(function () {
  ...
  const DICT = {
    fr: {
      ...
      dash_inactive_trial_over: "Votre essai gratuit est terminé — abonnez-vous pour continuer.",
      ...
      ed_scope_denied: "Vous pouvez uniquement déplacer les invités. La modification a été annulée.",
    ...
    en: {
      ...
      dash_inactive_trial_over: "Your free trial has ended — subscribe to continue.",
      ...
      ed_scope_denied: "You can only move guests. The change has been reverted.",
